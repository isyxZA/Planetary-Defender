...
if isMoving
{
	...
	if part_emitter_exists(global.particleSystem, p2Emitter)
	{
		if (abs(hSpeed) + abs(vSpeed)) / 10 > 1
		{
		part_emitter_region(global.particleSystem, p2Emitter, x - 1, x + 1, y - 1, y + 1, ps_shape_line, ps_distr_linear);
		part_emitter_stream(global.particleSystem, p2Emitter, oParticles.partExhaust, -15);
		}
		else
		{
			part_emitter_stream(global.particleSystem, p2Emitter, oParticles.partExhaust, 0);
		}
	}
}
else
